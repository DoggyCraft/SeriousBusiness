...
public class LawsuitCommandExecuter implements CommandExecutor
{
	...
	private void CommandLawsuit(CommandSender sender)
	{
		...
		sender.sendMessage(ChatColor.YELLOW + "  If the court finds the company GUILTY, the company will be fined " + ChatColor.WHITE + "15%" + ChatColor.YELLOW + " of their company account");
